...
前面說過，單方向的常態化有一個缺點，我們對一個方向(州)做常態化之後，另外一個方向(品類)的數值就失去了比較的基礎；如果我們想要在兩個方向上同時做分類和比較，我們可以把矩陣的「標準化殘差(standardized residuals)」畫成熱圖

**標準化殘差 (standardized residuals):**<br>
