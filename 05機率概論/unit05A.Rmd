...
par(mfrow=c(1,2), mar=c(2,5,3,1), family="BL", cex=0.8)
...
```{r fig.width=8, fig.height=2}
par(mfrow=c(1,4), mar=c(2,3,3,1), family="BL", cex=0.75)
...
```{r  fig.width=8, fig.height=2}
par(mfrow=c(1,3), mar=c(2,5,2,1), family="BL", cex=0.7, bty='n')
...
```{r fig.width=8, fig.height=2}
par(mfrow=c(1,4), mar=c(2,5,3,1), family="BL", cex=0.75)
